    ...
    <>
      <div className="mt-8 lg:mt-10 mb-0 sm:mt-8 sm:mb-8 lg:mb-6 flex-col sm:flex-row flex grow items-start sm:items-center justify-start mx-auto max-w-4xl">
        ...
        <div className="flex flex-wrap">
          <h1 className="text-4xl mr-4 -mt-1 flex wrap font-bold leading-tight text-primary dark:text-primary-dark">
            Digital Support Services Notes
          </h1>
      ...
      <section className="my-8 sm:my-10 grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-4">
        <div className="flex flex-col justify-center">
          <YouWillLearnCard title="Year 1 Notes" path="/learn">
            <p>The notes for Year 1 on the course.</p>
          </YouWillLearnCard>
        </div>
        <div className="flex flex-col justify-center">
          <YouWillLearnCard title="Year 2 Notes" path="/apis">
            <p>Notes for Year 2 on the course.</p>
          </YouWillLearnCard>
        </div>
      </section>
    </>
