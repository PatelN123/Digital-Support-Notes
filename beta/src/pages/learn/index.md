...
Business Environments are things such as `B2B`, `B2C`, `B2M`.
</Intro>

<YouWillLearn>

- Business to Business (and an example)
- Business to Customer (and an example)
- Business to Many (and an example)
- Key factors that can influence business environment (PESTLE)
