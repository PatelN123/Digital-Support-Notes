...
export default function page() {
  return (
    <Layout title="Digital Support Services Notes" description="Digital Support Services (T Level) notes - An awesome textbook alternative, that you can contribute to!">
      <Head>
