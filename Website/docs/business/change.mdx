...
Change requires management, preperation, planning and operations. 
...
## Operations
- Interaction of new or upgarded tools and processes into current digital ecosystem
- Establishing best practice for use of new or upgraded tools and practices
...
- Planning for change
    ...
    - Clarifying resources requried (for example hardware, software, staffing)
