...
`5.` Implement the solution. Determining the root cause will likely indicate one or several solutions. You might be able to implement the solution right away. Or, the solution may require some additional work. Either way, RCA isn't done until you’ve implemented a solution. <br />
`6.` Document actions taken. After you’ve identified and sloved he root problem, document the problems and the overall resolution so that future engineers can use it as a resource. <br />
