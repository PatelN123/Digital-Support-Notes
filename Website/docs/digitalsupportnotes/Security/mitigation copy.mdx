...
A software firewall is a program which runs on an indivudual device and just protects that device from outside intrusion.

## Paramaters
The paramaters that can filter traffic are: <br />
