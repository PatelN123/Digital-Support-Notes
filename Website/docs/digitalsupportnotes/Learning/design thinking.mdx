...
### Stage 1: Empathise
This is the first stage of the process where you'll need to gain full understandig of your users  and their needs. THis is known as a human centered deign process, and it is key to this whole process. <br />
...
Any problems found should be collected as a problem statment. `-` This is a concise description of the problem <br />
