...
The service is seperated from the backend and the API will work wether it is communicating directly with a server. <br />



**SOAP** <br />
Simple Object Access Protocol <br />
Able to operate over a range of communciation protocols, such as HTTP, SMTP, TCP and more. <br />
It is also extensible and style-independent, which allows developers to write SOAP APIs in verious ways and easily add features and functionality. <br />
