...
This is a visual, hierachical and deliverable orientated deconstruction of a project. <br />
It allows project managers to break down their project scop and visualise all the tasks required to complete their projects. <br />
...
### Responsible **(R)**
` - ` The persopn directly incharge of the work. This should only be one person. <br/>
...
It's based pn the [agile](https://notes.nayanpatel.net/docs/agile/) method of project management, which aims to strictly establish factors like the cost of a product, quality, and requirments as early as possible. 
