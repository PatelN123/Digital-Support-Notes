...
- A core is an independant processor that can run its own fetch decode execute cycle. For example, a processor with 4 cores can run 4 FDE cycles simultaneously, and therefore is 4x faster. A processor with 8 cores is 8x faster.
