...
Change requires management, preperation and planning and operatins. 
...
- Establishing best practice for use of new or upgraded toold and processes
...
- Resistance to chnage from staff / teams
...
Whhen making changes, it is important to document and log everything you do, in case you need to roll back. 
...
- New or amended:
    - Policies (for exampple updated health and safety, due to changes in legislation)
...
- Managing change implementation
    - Monitoring process during implimentation
...
- Reinforcing change
    - Reinforcment planning
        - What steps to take if change isn't implemented quickly enoug
