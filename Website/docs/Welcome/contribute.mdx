...
import DC from '@site/src/components/DC';
import DCs from '@site/src/components/DCs';
...
<DocsCards>
  <DocsCard header="Test" href="test" icon="https://docusaurus.io/img/docusaurus.svg">
    <p>testing</p>
  </DocsCard>