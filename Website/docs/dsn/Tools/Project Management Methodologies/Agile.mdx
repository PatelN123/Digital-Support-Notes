...
1. `Envision`
    1. The project and overall product are first conceptualized in this phase and the needs of the end customers are identified. This phase also determines who is going to work on the project and its stakeholders. 
2. `Speculate`
...
- More freedom
    - Project management lets designers work on models that utilize their strengths
