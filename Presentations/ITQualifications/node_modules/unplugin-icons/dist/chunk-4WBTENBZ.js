...
var _chunkNP34SPMFjs = require('./chunk-NP34SPMF.js');
...
function searchForIcon(iconSet, collection, ids, options) {
  ...
  for (const id of ids) {
    ...
    if (iconData) {
      ...
      const { attributes, body } = _build.iconToSVG.call(void 0, iconData, _chunkNP34SPMFjs.__spreadProps.call(void 0, _chunkNP34SPMFjs.__spreadValues.call(void 0, {}, _customisations.defaults), {
        height: `${scale}em`,
        width: `${scale}em`
      }));
