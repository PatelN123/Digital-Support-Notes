...
- Fiber Optic - Glass and plastic threads. Transmits data in the form of modulated light waves. Much higher data transmission rate. No issues with interference. Used for long distance cable runs. 
