...
var _SearchMetadata = _interopRequireDefault(require("@theme/SearchMetadata"));
...
function LayoutHead(props) {
  ...
  return <>
      ...
      <_SearchMetadata.default tag={_themeCommon.DEFAULT_SEARCH_TAG} locale={currentLocale} {...searchMetadata} />
    ...
    >
        ...
        {metadata.map((metadatum, i) => <meta key={`metadata_${i}`} {...metadatum} />)}
      </_Head.default>
    </>;
}