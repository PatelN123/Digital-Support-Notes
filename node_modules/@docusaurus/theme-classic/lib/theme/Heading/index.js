...
const createAnchorHeading = Tag => ({
  ...
  return <Tag {...props} className={(0, _clsx.default)('anchor', {
    [_stylesModule.default.anchorWithHideOnScrollNavbar]: hideOnScroll,
    [_stylesModule.default.anchorWithStickyNavbar]: !hideOnScroll
  })} id={id}>
        {props.children}
        <a aria-hidden="true" className="hash-link" href={`#${id}`} title={(0, _Translate.translate)({
...
const Heading = headingType => headingType === 'h1' ? MainHeading : createAnchorHeading(headingType);
