...
function DocVersionBannerEnabled({
  ...
  return <div className={(0, _clsx.default)(className, _themeCommon.ThemeClassNames.docs.docVersionBanner, 'alert alert--warning margin-bottom--md')} role="alert">
      <div>
...
function DocVersionBanner({
  ...
  const versionMetadata = (0, _themeCommon.useDocsVersion)();
