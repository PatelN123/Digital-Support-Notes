...
function DocPageContent({
  ...
  const sidebar = (0, _themeCommon.useDocsSidebar)();
  const {
    pluginId,
    version
  } = versionMetadata;
  ...
  return <_Layout.default wrapperClassName={_themeCommon.ThemeClassNames.wrapper.docsPages} pageClassName={_themeCommon.ThemeClassNames.page.docsDocPage} searchMetadata={{
    version,
...
function DocPage(props) {
  ...
  return <>
      ...
      <_themeCommon.DocsVersionProvider version={versionMetadata}>
        <_themeCommon.DocsSidebarProvider sidebar={sidebar}>
          <DocPageContent currentDocRoute={currentDocRoute} versionMetadata={versionMetadata} sidebarName={sidebarName}>
            {(0, _renderRoutes.default)(docRoutes, {
            versionMetadata
          })}
          </DocPageContent>
        </_themeCommon.DocsSidebarProvider>
      </_themeCommon.DocsVersionProvider>
    </>;
}
